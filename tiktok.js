...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const background=[new Layer(-20,createImages({imageScr:'3.png'}), 1),new Layer(2000,createImages({imageScr:'3.png'}), 1), new Layer(4050,createImages({imageScr:'3.png'}), 1)]

    const logos=[new Logo(10,10, createImages({imageScr:"tiktok.png"}),0.8),new Logo(2000,30, createImages({imageScr:"tiktok.png"}),1.34),
        new Logo(2500,60, createImages({imageScr:"tiktok.png"}),0.5),new Logo(3410,80, createImages({imageScr:"tiktok.png"}),0.78),
        new Logo(5900,60, createImages({imageScr:"tiktok.png"}),0.5), new Logo(7700,400, createImages({imageScr:"tiktok.png"}),0.63)]


    const logo1=new Logo(1150,100, createImages({imageScr:"tq.png"}),1.22)
    const logo2=new Logo(3000,70, createImages({imageScr:"tq.png"}),1.28)
    const logo3=new Logo(5000,90, createImages({imageScr:"tq.png"}),1.33)
    const logo4=new Logo(6500,250, createImages({imageScr:"tq.png"}),1.15)
